...
test("el visor exporta rangos inclusivos como un PDF rasterizado descargable", () => {
  ...
  assert.match(pdfJs, /pdfjs-custom-cut-start/)
  assert.match(pdfJs, /pdfjs-custom-cut-end/)
  ...
  assert.match(pdfJs, /_paginas-\$\{range\.startPage\}-\$\{range\.endPage\}/)
  assert.match(pdfJs, /URL\.createObjectURL/)
  assert.match(pdfJs, /card\.dataset\.pageNumber/)
  assert.match(css, /pdfjs-custom-cut-fields/)
})
